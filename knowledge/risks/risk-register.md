...
|---|---|---|---|
| **R3** | [D1](/decisions/d1-claim-commit-with-padding.md)'s claim/commit padding is a **genuine extension with no reference implementation to check against**. | high | Dedicated boundary tests ([L1](/testing/l1-unit.md)), randomised sizes ([L2](/testing/l2-property.md)), [triangulation](/practices/triangulation.md). |
